    ...
    <div class="woocommerce-box border-box">
      ...
      <form method="post" class="login brad-woocommerce-form brad-woocommerce-login">
        ...
        <p class="form-row alignleft">
          ...
          <input type="submit" class="button  button_small" name="login" value="<?php _e( 'Login', 'woocommerce' ); ?>" />
    ...
    <div class="woocommerce-box border-box">
      ...
      <form method="post" class="register brad-woocommerce-form">
        ...
        <p class="form-row">
          ...
          <input type="submit" class="button  button_small" name="register" value="<?php _e( 'Register', 'woocommerce' ); ?>" />
        </p>
