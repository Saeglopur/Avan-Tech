...
<div id="order_review" class="order_review">
  ...
  <div id="payment">
    ...
    <div class="form-row place-order">
      ...
      <br/>
      <input type="submit" class="button   button_small alt" name="woocommerce_checkout_update_totals" value="<?php _e( 'Update totals', 'woocommerce' ); ?>" />
      </noscript>
      ...
      <?php
			...
			echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="button   button_small alt" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' );
			?>
